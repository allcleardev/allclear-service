...
public class App extends Application<Config>
{
	...
	public static final Class<?>[] ENTITIES = new Class<?>[] { Conditions.class, CountByName.class, Exposures.class, Facility.class, FacilityX.class, FacilityTestType.class, Friend.class, Friendship.class, Named.class, People.class, PeopleFacility.class, PeopleField.class, Symptoms.class, SymptomsLog.class, Tests.class, Total.class };
