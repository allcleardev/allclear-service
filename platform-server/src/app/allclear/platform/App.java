...
public class App extends Application<Config>
{
	...
	public static final Class<?>[] ENTITIES = new Class<?>[] { Conditions.class, CountByName.class, Exposures.class, Facility.class, FacilityX.class, Friend.class, Friendship.class, Named.class, People.class, PeopleFacility.class, Symptoms.class, SymptomsLog.class, Tests.class };
