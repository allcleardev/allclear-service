...
public class TestsDAOTest
{
	...
	public void add()
	{
		...
		var value = dao.add(VALUE = new TestsValue(PERSON.id, FIRST.id, TAKEN_ON, FACILITY.id, false, "All the other details"));
	...
	*/
	...
	{
		return new TestsValue(PERSON_1.id, SECOND.id, TAKEN_ON_1, FACILITY_1.id, true, "Some more information");
	}
