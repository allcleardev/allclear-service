...
public class ConfigTest
{
	...
	public void dev() throws Exception
	{
		...
		Assertions.assertEquals("%s\nUse this code for AllClear verification or click this link:\nhttps://app-dev.allclear.app/register?phone=%s&code=%s", o.registrationSMSMessage, "Check registrationSMSMessage");
	...
	public void local() throws Exception
	{
		...
		Assertions.assertEquals("+16466321488", o.registrationPhone, "Check registrationPhone");
		Assertions.assertEquals("+16466321488", o.authenticationPhone, "Check authenticationPhone");
		Assertions.assertEquals("%s\nUse this code for AllClear verification or click this link:\nhttp://localhost:8080/register?phone=%s&code=%s", o.registrationSMSMessage, "Check registrationSMSMessage");
	...
	public void prod() throws Exception
	{
		...
		Assertions.assertEquals("+16466321488", o.registrationPhone, "Check registrationPhone");
		Assertions.assertEquals("+16466321488", o.authenticationPhone, "Check authenticationPhone");
		Assertions.assertEquals("%s\nUse this code for AllClear verification or click this link:\nhttps://app.allclear.app/register?phone=%s&code=%s", o.registrationSMSMessage, "Check registrationSMSMessage");
	...
	public void test() throws Exception
	{
		...
		Assertions.assertEquals("+16466321488", o.registrationPhone, "Check registrationPhone");
		Assertions.assertEquals("+16466321488", o.authenticationPhone, "Check authenticationPhone");
		Assertions.assertEquals("%s\nUse this code for AllClear verification or click this link:\nhttps://app-test.allclear.app/register?phone=%s&code=%s", o.registrationSMSMessage, "Check registrationSMSMessage");
