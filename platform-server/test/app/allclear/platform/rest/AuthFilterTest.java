...
public class AuthFilterTest
{
	...
	public static Stream<Arguments> admin()
	{
		return Stream.of(
			...
			arguments("auditLogs", false),
			arguments("auditLogs/facilities", false),
			arguments("/auditLogs", false),
			arguments("/auditLogs/facilities", false),
	...
	public static Stream<Arguments> admins()
	{
		return Stream.of(
			...
			arguments("/admins/self", false),
			arguments("/admins/search", false),
			arguments("auditLogs", true),
			arguments("auditLogs/facilities", true),
			arguments("/auditLogs", false),
			arguments("/auditLogs/facilities", false),
	...
	public static Stream<Arguments> requiresAuth()
	{
		return Stream.of(
			...
			arguments("customers/123", true),
			arguments("customers/search", true),
			arguments("experiences", true),
			arguments("experiences/123", true),
			arguments("experiences/calc", false),
			arguments("/experiences/calc", true),
			arguments("experiences/search", true),
			arguments("facilitates/citizen", false),
			arguments("facilitates/provider", false),
			arguments("facilitates/search", false),
			arguments("facilitates/o/123", true),
			arguments("facilitates/o/1234/promote", true),
			arguments("facilitates/p/555555/reject", true),
			arguments("facilities", false),
			arguments("facilities/123", false),
			arguments("facilities/cities", false),
			arguments("facilities/name", false),
			arguments("facilities/search", false),
			arguments("facilities/states", false),
			arguments("/facilities", true),
			arguments("/facilities/123", true),
			arguments("/facilities/cities", true),
			arguments("/facilities/name", true),
			arguments("/facilities/search", true),
			arguments("/facilities/states", true),
			arguments("info/config", true),
			arguments("info/health", false),
			arguments("info/ping", false),
			arguments("info/version", false),
	...
	public static Stream<Arguments> failure()
	{
		return Stream.of(
			...
			arguments("auditLogs", "", "Session ID is required."),
			arguments("auditLogs", null, "Session ID is required."),
			arguments("auditLogs", PERSON.id, "Requires an Administrative Session."),
			arguments("auditLogs", START.id, "Requires an Administrative Session."),
			arguments("auditLogs", EDITOR.id, "Requires an Administrative Session."),
			arguments("auditLogs/facilities", "", "Session ID is required."),
			arguments("auditLogs/facilities", null, "Session ID is required."),
			arguments("auditLogs/facilities", PERSON.id, "Requires an Administrative Session."),
			arguments("auditLogs/facilities", START.id, "Requires an Administrative Session."),
			arguments("auditLogs/facilities", EDITOR.id, "Requires an Administrative Session."),
			...
			arguments("experiences", null, "Session ID is required."),
			arguments("experiences", "", "Session ID is required."),
			arguments("experiences/123", null, "Session ID is required."),
			arguments("experiences/123", "", "Session ID is required."),
			arguments("experiences/search", null, "Session ID is required."),
			arguments("experiences/search", "", "Session ID is required."),
	...
	public static Stream<Arguments> success()
	{
		return Stream.of(
			...
			arguments("auditLogs", ADMIN.id),
			arguments("auditLogs", SUPER.id),
			arguments("auditLogs/facilities", ADMIN.id),
			arguments("auditLogs/facilities", SUPER.id),
			...
			arguments("experiences/calc", null),
			arguments("experiences/calc", ""),
			arguments("facilities", null),
			...
			arguments("facilities/cities", null),
			arguments("facilities/name", null),
			arguments("facilities/name", PERSON.id),
			...
			arguments("facilities/states", null),
