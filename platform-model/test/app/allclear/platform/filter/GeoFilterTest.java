...
public class GeoFilterTest
{
	public static Stream<Arguments> valid()
	{
		return Stream.of(
			...
			arguments(null, null, "Philadelphia", 10, null, false, milesToMeters(10)),
			arguments(null, null, null, null, 10, false, kmToMeters(10)),
			arguments(null, null, "Philadelphia", null, 10, false, kmToMeters(10)),
			arguments(null, null, null, 10, 10, false, milesToMeters(10)),
			arguments(null, null, "Philadelphia", 10, 10, false, milesToMeters(10)),
			...
			arguments(null, "40", "Philadelphia", 10, null, false, milesToMeters(10)),
			arguments("30", null, null, 10, null, false, milesToMeters(10)),
			arguments("30", null, "Philadelphia", 10, null, false, milesToMeters(10)),
			arguments(null, "40", null, null, 10, false, kmToMeters(10)),
			arguments(null, "40", "Philadelphia", null, 10, false, kmToMeters(10)),
			arguments("30", null, null, null, 10, false, kmToMeters(10)),
			arguments("30", null, "Philadelphia", null, 10, false, kmToMeters(10)),
