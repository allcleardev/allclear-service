...
public class Validator
{
	...
	public static final String CODE_INVALID_CREDENTIALS = "AUTH-101";
	public static final String CODE_INVALID_LOGIN_ID = "AUTH-102";
	public static final String CODE_MISSING_EMAIL_ADDRESS = "AUTH-103";
	public static final String CODE_NEW_PASSWORD_MISMATCH = "AUTH-104";
	public static final String CODE_CANNOT_CHANGE_PASSWORD = "AUTH-105";
	public static final String CODE_INVALID_CURRENT_PASSWORD = "AUTH-106";
	public static final String CODE_PASSWORD_TOO_SHORT = "AUTH-107";
	public static final String CODE_PASSWORD_TOO_LONG = "AUTH-108";
	public static final String CODE_PASSWORD_MISSING_LOWER_CASE_CHAR = "AUTH-109";
	public static final String CODE_PASSWORD_MISSING_UPPER_CASE_CHAR = "AUTH-110";
	public static final String CODE_PASSWORD_MISSING_NUMBER = "AUTH-111";
	public static final String CODE_PASSWORD_MISSING_SYMBOL = "AUTH-112";
	public static final String CODE_PASSWORD_INVALID_CHAR = "AUTH-113";
	public static final String CODE_INVALID_VALUE = "AUTH-114";
	public static final String CODE_MUST_CHANGE_PASSWORD = "AUTH-115";
